...
function DetailModal({ booking, onClose, onStatusChange, onRekamMedis, saving }: {
  booking:        Booking;
  onClose:        () => void;
                          ...
                          <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                            ...
                            {b.status === "dikonfirmasi" && (
                              <button
                                ...
                                style={{ display: "inline-flex", alignItems: "center", gap: 5, padding: "7px 12px", borderRadius: 8, border: "1.5px solid #1565c0", background: "#fff", color: "#1565c0", fontSize: 12, cursor: "pointer", fontFamily: "inherit", whiteSpace: "nowrap" }}
                                onMouseEnter={e => { (e.currentTarget as HTMLButtonElement).style.background = "#1565c0"; (e.currentTarget as HTMLButtonElement).style.color = "#fff"; }}
                                onMouseLeave={e => { (e.currentTarget as HTMLButtonElement).style.background = "#fff"; (e.currentTarget as HTMLButtonElement).style.color = "#1565c0"; }}
                              >
                                <ClipboardList size={12} /> Rekam Medis
                              </button>
                            )}
                          </div>
                        </td>
